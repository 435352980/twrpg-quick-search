...
export interface SelectProps<T> {
  ...
  contentRenderer?: ({ props, state, methods }: SelectRenderer<T>) => JSX.Element | string;
  ...
  inputRenderer?: ({
    ...
    methods,
    inputRef,
  }: SelectRenderer<T> & { inputRef: React.RefObject<HTMLInputElement> }) => JSX.Element;
  itemRenderer?: ({ item, itemIndex, props, state, methods }: SelectItemRenderer<T>) => JSX.Element;
...
declare const Select: <T extends object | string = {}>(
